...
timestamp_lt = 1640996051  # 2023-08-01 00:00

# Open the file in append mode
with open("0.05_burns_gas_fee_data.json", "a") as file:
    max_retries = 3
    last_burn = None
    repetition_count = 0
    ...
    while True:
        ...
        while retry_count < max_retries:
            try:
                ...
                if response.status_code == 200:
                    ...
                    for burn in burns:
                        file.write(json.dumps(burn) + "\n")

                    if last_burn and last_burn == burns[-1]:
                        repetition_count += 1
                    ...
                    last_burn = burns[-1]
                    last_timestamp = int(last_burn["transaction"]["timestamp"])
        ...
        if not burns or last_timestamp >= timestamp_lt:
            break
